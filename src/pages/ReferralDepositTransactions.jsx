...
const ReferralDepositTransactions = () => {
  ...
  const fetchDepositTransactions = async (startDate, endDate) => {
    ...
    try {
      ...
      const response = await apiHelper.get(`/referal/getDeposit_Users_Tranx_forReferal_Dashboard?startDate=${formatDate(start)}&endDate=${formatDate(end)}&referalCode=${selectedBranch}`);
...
export default ReferralDepositTransactions;