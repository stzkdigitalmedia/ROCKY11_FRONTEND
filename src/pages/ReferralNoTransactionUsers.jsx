...
const ReferralNoTransactionUsers = () => {
    ...
    const fetchNoTransactionUsers = async (startDate, endDate) => {
        setLoading(true);
        try {
            ...
            const response = await apiHelper.get(`/referal/getUsers_of_No_Tranx_forReferal_Dashboard?startDate=${startUTC}&endDate=${endUTC}&referalCode=${selectedBranch}&page=1&limit=10000`);
    ...
    const applyDateFilter = () => {
        fetchNoTransactionUsers(dateRange[0].startDate, dateRange[0].endDate);
                    ...
                    <div className="gaming-card p-4 sm:p-6">
                        ...
                        {loading ? (
                            ...
                            <div className="text-center py-8 text-gray-500">
                                ...
                                <p className="text-sm">No users without transactions for the selected date range</p>
                            </div>
                        ) : (
...
export default ReferralNoTransactionUsers