...
const ReferralUserRegistrations = () => {
  ...
  const fetchUserRegistrations = async (startDate, endDate) => {
    ...
    try {
      ...
      const response = await apiHelper.get(`/referal/getUsers_Created_By_Date_for_Referal_Dashboard?startDate=${startUTC}&endDate=${endUTC}&referalCode=${selectedBranch}&page=1&limit=10000`);
...
export default ReferralUserRegistrations