...
const ReferralWithdrawalTransactions = () => {
    ...
    const fetchDepositTransactions = async (startDate, endDate) => {
        ...
        try {
            ...
            // const response = await axios.post('https://www.powerdreams.co/api/online/transaction/getDeposit_WithdrawalTransaction_RRPay', payload);
            // const transactionData = response?.data?.data?.requests_Data || [];

            const response = await apiHelper.get(`/referal/getWithdraw_Users_Tranx_forReferal_Dashboard?startDate=${formatDate(start)}&endDate=${formatDate(end)}&referalCode=${selectedBranch}`);
                                ...
                                <table className="w-full">
                                    <thead className="table-header">
                                        <tr>
                                            ...
                                            <th className="text-left py-3 px-4 text-xs font-medium text-gray-500 uppercase tracking-wider">Total Withdrawal</th>
...
export default ReferralWithdrawalTransactions