...
//       const response = await axios.post('https://www.powerdreams.co/api/online/transaction/get_Transaction__Status_Breakdown_RRPay', payload);
...
//                               {(user?.clientUserName || 'U').charAt(0).toUpperCase()}
//                             </div>
//                             <div>
//                               <p className="font-medium text-gray-900">{user?.clientUserName}</p>
//                             </div>
//                           </div>
//                         </td>
//                         <td className="py-4 px-4">
...
//                             ₹{user?.amount || 0}
//                           </p>
//                           <p className="text-xs text-gray-500">{user?.transactionType || 'N/A'}</p>
//                         </td>
//                         <td className="py-4 px-4">
//                           <p className="text-sm text-gray-900">{user?.transaction_id || 'N/A'}</p>
//                         </td>
//                         <td className="py-4 px-4">
//                           <p className="text-sm text-gray-900">{user?.branchUserName || 'N/A'}</p>
//                         </td>
//                         <td>
//                           {new Date(user?.reqCreateTime).toLocaleString("en-IN")}
//                         </td>
//                       </tr>
//                     ))}
//                   </tbody>
...
const StatusDetails = () => {
  ...
  const fetchUsersByStatus = async (startDate, endDate) => {
    ...
    try {
      ...
      const response = await apiHelper.get(`/transaction/getUsersByTransactionStatus_forDashboard?status=${payload?.status}&startDate=${payload?.startDate}&endDate=${payload?.endDate}`);
