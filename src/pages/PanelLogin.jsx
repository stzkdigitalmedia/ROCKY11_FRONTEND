...
const PanelLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await apiHelper.post('/auth/panel_login', formData);
      ...
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-md w-full">
        <div className="p-6 md:p-8">
          <div className="text-center mb-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Panel Login</h2>
            <p className="text-gray-600">Access Panel Dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
            ...
            >
              {loading ? 'Signing in...' : 'Sign In as Panel'}
            </button>
          </form>
