      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 mb-6 overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            {activeTab === "user" ? (
              ...
              <>
                ...
                <div
                  onClick={() =>
                    document.getElementById("gameStartDate").showPicker?.()
                  }
                  className="cursor-pointer"
                >
                  <label className="block text-sm font-medium text-gray-700 mb-1 cursor-pointer">
                ...
                <div
                  onClick={() =>
                    document.getElementById("gameEndDate").showPicker?.()
                  }
                  className="cursor-pointer"
                >
                  <label className="block text-sm font-medium text-gray-700 mb-1 cursor-pointer">
        ...
        <div className="gaming-card">
          {(() => {
            ...
            const gameTxns = Array.isArray(gameTransactions)
              ? gameTransactions
              : [];
                              ...
                              <div>
                                <p className="text-sm font-medium text-gray-900">
                                  {transaction?.gameName ||
                                    transaction?.gameDetails?.game_name ||
                                    "N/A"}
                                </p>
                                {(transaction?.subProvider ||
                            ...
                            <td className="py-4 px-4">
                              <p className="text-sm font-medium text-gray-900">
                                {transaction?.providerName ||
                                  transaction?.gameDetails?.provider_name ||
                                  "N/A"}
                              </p>
                            </td>
                            <td className="py-4 px-4">
